...
src/%.o: ../src/%.c
	...
	avr-gcc -I"/home/amp/shared/polygraph/eclipse-workspace/ArduinoCore/src" -Wall -g2 -gstabs -Os -ffunction-sections -fdata-sections -std=gnu99 -mmcu=atmega168 -DF_CPU=16000000UL -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -c -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
